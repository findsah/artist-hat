            ...
            <div className='account_leftBar px-0'>
                ...
                <div className='account-navbar'>
                    ...
                    <div className='skills-inner-sec py-2 my-2'>
                        ...
                        <div className='text-end account_nav_item'><button className={`account-tabs ${tabActive === 9 ? "backgrond-active" : ""}`} onClick={() => toggleTab(9)}><h3 className='skills'>TAKS INFO</h3></button></div>
